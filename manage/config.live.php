...
$conf['hidden_template_indicator'] = "_"; // do not set this to "_" because then templates laoded via ajax will be hidden
...
$conf['ed_cache_path'] = $conf['server_path'].'/resizer_cache/';
