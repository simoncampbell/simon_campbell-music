...
class Member {
	...
	function member_delete()
	{
		...
		if ($SESS->check_password_lockout($SESS->userdata['username']) === TRUE)
		{
		...
		{
			$SESS->save_password_lockout($SESS->userdata['username']);
    ...
    function smileys()
    {
        ...
        function add_smiley(smiley)
        {
			...
			var el = opener.window.document.getElementById('submit_post').body;
			el.value += " " + smiley + " ";
			el.focus();
