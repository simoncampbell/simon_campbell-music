...
$gateway_info = array(
	'title' => "Paypal Pro UK",
	'classname' => 'Cartthrob_paypal_pro_uk',
...
if ( ! class_exists($gateway_info['classname']))
{
	...
	class Cartthrob_paypal_pro_uk extends Cartthrob_payment_gateway
	{
	
		function Cartthrob_paypal_pro_uk()
		{
			$this->Cartthrob();
		...
		function _charge_sale($total,$credit_card_number, $customer_info, $order_id='')
		{
			...
			'COUNTRYCODE' 	=> $this->_get_alpha2_country_code($customer_info['country_code']),
			'ZIP' 			=> $customer_info['zip'],
			'AMT' 			=> $total,
			'CURRENCYCODE' 	=> !empty($customer_info['currency_code']) 				? $customer_info['currency_code'] : "GBP",
...
/* End of file cartthrob.paypal_pro_uk.php */
/* Location: ./system/modules/payment_gateways/cartthrob.paypal_pro_uk.php */