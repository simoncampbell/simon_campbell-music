...
$plugin_info = array(
	'title' => 'CALCULATED By Location - Weight Threshold',
	'classname' => 'Cartthrob_by_location_weight_threshold',
	'note' => 'Costs are set at weight intervals for each location.',
	'settings' => array(
		array(
		...
		array(
			...
			'settings' => array(
				...
				array(
					...
					'note' => '(ex: 0lbs - 10lbs would be entered as: <span class="red">10</span>)',
					'type' => 'text'
				)
			)
		)
...
{
	class Cartthrob_by_location_weight_threshold extends Cartthrob_shipping_plugin
	{

		function Cartthrob_by_location_weight_threshold()
		{
		...
		function get_shipping()
		{
			...
			return $this->_get_shipping_from_location_thresholds($this->shipping_weight_total());
		}
...
/* End of file cartthrob.by_location_price_threshold.php */
/* Location: ./system/modules/shipping_plugins/cartthrob.by_location_price_threshold.php */