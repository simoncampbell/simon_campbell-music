...
$plugin_info = array(
	'title' => 'CALCULATED By Location - Price Threshold',
	'classname' => 'Cartthrob_by_location_price_threshold',
	'note' => 'Costs are set at price intervals for each location.',
	'settings' => array(
		array(
...
{
	class Cartthrob_by_location_price_threshold extends Cartthrob_shipping_plugin
	{

		function Cartthrob_by_location_price_threshold()
		{
		...
		function get_shipping()
		{
			...
			return $this->_get_shipping_from_location_thresholds($subtotal);
		}
