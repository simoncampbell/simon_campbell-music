...
/*
 * This file is a copy of the original core.language.php file with
 * the lang function removed. This is so that we can use language
 * files before $LANG is instantiated.
 */
