{embed="_layout/_start"
    ...
    <div id="content_pri">
        ...
        <div class="widget">
            <h3>My big bastard gear list</h3>
            <p>
                I have over the years used a bewildering array of gear on my never ending journey to find the 'perfect tone'. If you are interested, take a look at <a href="#">the articles</a> that I have written on the subject.
            </p>
        </div><!-- // .widget -->
